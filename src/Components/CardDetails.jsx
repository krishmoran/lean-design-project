...
function CardDetails({image, brand, year, model, distance, price, address, postDate, description, sellerName, memeberSince, fuel, rating, totalOwners, category}){
    return (
            ...
            <div className={styles.subContainer}>
                ...
                <div style={{textAlign: "left", border: "1px solid #CCD5D6"}}>
                    ...
                    <div className={styles.spanCont}>
                        <span style={{color: "rgba(0,47,52,.64)", marginBottom: "2%"}}>Category</span><span style = {{color: "#002F34"}}>{category}</span>
                        <span style={{color: "rgba(0,47,52,.64)"}}>Rating</span><span style = {{color: "#002F34"}}>{rating[0]}</span>
                    </div>
                    <hr />
